...
string GLSpotLightSource::_glsl_names[2] = { "cone_angle", "cone_direction", "inner_cone_angle", "outer_cone_angle"};
#endif
...
bool GLSpotLightSource::addVariablesToProgram(GLuint program, int variable_index)
{
    ...
    _inner_cone_angleIdx = glGetUniformLocation(program, GetVariableName(_glsl_object, _glsl_names[2], variable_index).c_str());
    checkUniform(_inner_cone_angleIdx, GetVariableName(_glsl_object, _glsl_names[2], variable_index));
    _outer_cone_angleIdx = glGetUniformLocation(program, GetVariableName(_glsl_object, _glsl_names[3], variable_index).c_str());
    checkUniform(_outer_cone_angleIdx, GetVariableName(_glsl_object, _glsl_names[3], variable_index));
