...
class Sphere1: public GLSphere {
public:
Sphere1(float center_x, float center_y, float center_z, float radius, int rows = 10, int segments = 10 );
    ~Sphere1(){};
...
class Sphere2: public GLSphere {
public:
Sphere2(float center_x, float center_y, float center_z, float radius, int rows = 10, int segments = 10 );
    ~Sphere2(){};
...
class Sphere3: public GLSphereSpot {
public:
Sphere3(float center_x, float center_y, float center_z, float radius, int rows = 10, int segments = 10 );
    ~Sphere3(){};
...
class Sphere4: public GLSphereSpot {
public:
Sphere4(float center_x, float center_y, float center_z, float radius, int rows = 10, int segments = 10 );
    ~Sphere4(){};
