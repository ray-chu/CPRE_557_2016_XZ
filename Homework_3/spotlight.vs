...
uniform float inner_cone_angle;
uniform float outer_cone_angle;
...
{                                                               
	...
	if(light_to_surface_angle > outer_cone_angle){
  		attenuation = 0.0;
	}
	//caculate the smooth coefficient;
	float smooth_coefficient=1.0;
	if(light_to_surface_angle<=outer_cone_angle&&light_to_surface_angle>=inner_cone_angle){
		smooth_coefficient=1.0-smoothstep(inner_cone_angle,outer_cone_angle,light_to_surface_angle);
	}
