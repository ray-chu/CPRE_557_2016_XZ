...
Sphere1::Sphere1(float center_x, float center_y, float center_z, float radius, int rows, int segments ):GLSphere()
{
...
Sphere2::Sphere2(float center_x, float center_y, float center_z, float radius, int rows, int segments ):GLSphere()
{
...
void GLSphere::initShader(void)
{
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    // Material
     _material._diffuse_material = glm::vec3(1.0, 0.5/*0.5*/, 0.0);
     _material._ambient_material = glm::vec3(1.0, 0.5/*0.5*/, 0.0);
...
void Sphere2::initShader(void){
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    // Material
     _material._diffuse_material = glm::vec3(0.0, 0.0/*0.5*/, 1.0);
     _material._ambient_material = glm::vec3(0.0, 0.0/*0.5*/, 1.0);
    _material._specular_material = glm::vec3(1.0, 1.0, 1.0);
    _material._shininess = 12.0;
    ...
    // define the position of the light and send the light position to your shader program
    _light_source0._lightPos = glm::vec4(32.0,30.0,10.0,1.0);
    _light_source0._ambient_intensity = 0.5;
    _light_source0._specular_intensity = 0.0;
    _light_source0._diffuse_intensity = 0.5;
...
void GLSphereSpot::initShader(void)
{
    ...
    // define the position of the light and send the light position to your shader program
    _light_source1._lightPos = glm::vec4(50.0,50.0,0.0, 1.0);
    ...
    _light_source1._inner_cone_angle = 90.0;//15.0; // in degree
    _light_source1._outer_cone_angle = 90.0;
    ...
    _light_source1._inner_cone_angleIdx = glGetUniformLocation(_program, "inner_cone_angle");
    _light_source1._outer_cone_angleIdx = glGetUniformLocation(_program, "outer_cone_angle");
    ...
    glUniform1f(_light_source1._inner_cone_angleIdx, _light_source1._inner_cone_angle);
    glUniform1f(_light_source1._outer_cone_angleIdx, _light_source1._outer_cone_angle);
...
void Sphere3::initShader(void){
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    // Material
     _material._diffuse_material = glm::vec3(0,1.0/*0.5*/, 0);
     _material._ambient_material = glm::vec3(0.0, 0.0/*0.5*/, 0.0);
    _material._specular_material = glm::vec3(1.0, 1.0, 1.0);
    _material._shininess = 64.0;
...
Sphere3::Sphere3(float center_x, float center_y, float center_z, float radius, int rows, int segments ):GLSphereSpot()
{
...
void Sphere4::initShader(void){
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    // Material
     _material._diffuse_material = glm::vec3(0.85, 0.85/*0.5*/, 0.10);
     _material._ambient_material = glm::vec3(0.85, 0.85/*0.5*/, 0.10);
    _material._specular_material = glm::vec3(1.0, 1.0, 1.0);
    _material._shininess = 24.0;
    ...
    // define the position of the light and send the light position to your shader program
    _light_source1._lightPos = glm::vec4(48.0,20.0,0.0,1.0);
    //_light_source1._lightPos = glm::vec4(20.0,50.0,20.0,1.0);
    _light_source1._ambient_intensity = 0.5;
    _light_source1._specular_intensity = 0.5;
    _light_source1._diffuse_intensity = 1.0;
    _light_source1._attenuation_coeff = 0.0;//0.02;
 
    _light_source1._inner_cone_angle = 10.0;//15.0; // in degree
    _light_source1._outer_cone_angle = 15.0;

    _light_source1._cone_direction = glm::vec3(-0.03, -1.0, -0.05); // this must be aligned with the object and light position.
...
Sphere4::Sphere4(float center_x, float center_y, float center_z, float radius, int rows, int segments ):GLSphereSpot()
{
